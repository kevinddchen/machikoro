...
export const Vineyard2: Establishment = {
  ...
  expansion: Expansion.Base,
  name: 'Vineyard',
  description: 'Get 2 coins from the bank.',
  cost: 1,
  earn: 2,
  rolls: [2],
  color: EstColor.Blue,
...
export const FlowerShop2: Establishment = {
  ...
  expansion: Expansion.Base,
  name: 'Flower Shop',
  description: 'Get 3 coins from the bank for each "Flower Garden" establishment you own.',
  cost: 1,
...
export const FurnitureFactory2: Establishment = {
  ...
  description: 'Get 4 coins from the bank for each ' + EstType.Gear + ' establishment you own.',
  cost: 4,
...
export const Winery2: Establishment = {
  ...
  expansion: Expansion.Base,
  name: 'Winery',
  description: 'Get 3 coins from the bank for each ' + EstType.Fruit + ' establishment you own.',
  cost: 3,
...
export const Mine2: Establishment = {
  ...
  expansion: Expansion.Base,
  name: 'Mine',
  description: 'Get 6 coins from the bank.',
  cost: 4,
  earn: 6,
  rolls: [11, 12],
  color: EstColor.Blue,
